...
from .models import Fixtures, Teams, Question, Players, CustomUser, usr_teams, configdata, Answer, entry_data, Total_Goal_Entry, entry_q_answers, entry_scorers, entry_data_new
...
admin.site.register(entry_data_new)
